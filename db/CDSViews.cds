...
using { samhitha.db.master, samhitha.db.transaction } from './datamodel';
...
context CDSViews {
    ...
    select from transaction.purchaseorder{
        key PO_ID as ![PurchaseOrderId],
         ...
         LIFESTYLE_STATUS as ![POStatus],
        key Items.PO_ITEM_POS as ![ItemPosition],
        Items.PRODUCT_GUID.PRODCUT_ID as ![ProductId],
   ...
   into{
    ...
    //Exposed Association, which means when someone readthe view
    //the data wont read by default
    //until unless someone consume association
    PO_ORDERS
